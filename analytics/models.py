...
class VacancyData(models.Model):
    ...
    salary_in_rub = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True,
                                        help_text="Salary converted to RUB")
...
class SiteConfiguration(models.Model):
    ...
    footer_text = models.TextField(
        default="Студент: Тренихин Михаил Александрович | Группа: РИ-231003 | Курс: Технологии программирования"
    )
